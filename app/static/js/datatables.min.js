...
l[h],p=a.aoData[m];null===p.nTr&&Za(a,m);var t=p.nTr;if(0!==e){var v=d[c%e];p._sRowStripe!=v&&(k(t).removeClass(p._sRowStripe).addClass(v),p._sRowStripe=v)}I(a,"aoRowCallback",null,[t,p._aData,c,h,m]);b.push(t);c++}else c=f.sZeroRecords,1==a.iDraw&&"ajax"==P(a)?c=f.sLoadingRecords:f.sEmptyTable&&0===a.fnRecordsTotal()&&(c=f.sEmptyTable),b[0]=k("<tr/>",{"class":e?d[0]:"container"}).append(k('<td/>',{valign:"top",colSpan:na(a)}).html(c))[0];I(a,"aoHeaderCallback","header",[k(a.nTHead).children("tr")[0],
...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": aktywuj, aby posortować rosnąco",sSortDescending:": aktywuj, aby posortować malejąco"},oPaginate:{sFirst:"Pierwsza",sLast:"Ostatnia",sNext:"Następna",sPrevious:"Poprzednia"},sEmptyTable:'<div class="container emptyTable"><i class="fas fa-sad-tear fa-5x"></i><br /><br /><h4>Brak elementów do wyświetlenia</h4></div>',sInfo:"Pokazuje _START_ - _END_ z _TOTAL_ wpisów",sInfoEmpty:"Pokazuje 0 z 0 wpisów",sInfoFiltered:"(z _MAX_ wyszukanych)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Pokaż _MENU_ wpisów",sLoadingRecords:"Ładowanie...",sProcessing:"Przetwarzanie...",sSearch:"Szukaj:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:'<div class="container emptyTable"><i class="fas fa-sad-tear fa-5x"></i><br /><br /><h4>Nic nie znaleziono</h4></div>'},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,
